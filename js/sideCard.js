...
$(document).ready(function(){
    ...
    $(".sideCard").click(function(){
        ...
        if(strNumber=="01"){
            ...
            //who is felix?
           // There is no doubt that the author of this website is people see people love,flower see flower bloom,handsome-handsomely-handsomer-handsomest,newber-
            //newbest,romantic&wind current,yu shu lin fen,young&beautiful,one and only,clever&smart,extraordinary,cute&lovely,cool&cold......
            //$("#aboutMeTextTitle").focus().typetype("who is felix???", {
            //    callback: function() {
